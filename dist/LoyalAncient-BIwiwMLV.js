...
//#region wp-content/themes/wingate/src/pages/LoyalAncient.jsx
function g() {
	...
	(0, _.useEffect)(() => {
		(async () => {
			r(!0);
			try {
				let e = await fetch("/wp-json/wingate-tools/v1/bar/public"), n = e.ok ? await e.json() : {
					settings: null,
					menus: [],
					weekdayLabels: {}
		...
		let e = a.context(() => {
			let e = g.current.querySelector(".bar-hero-copy");
			e && a.fromTo(e, {
				y: 26,
				opacity: 0
			}, {
			...
			let t = g.current.querySelectorAll(".bar-menu-card");
			t.length && a.fromTo(t, {
				y: 18,
				opacity: 0
			}, {
	...
	let S = e.settings || {}, C = e.menus || [], w = e.weekdayLabels || {}, T = C.find((e) => Number(e.id) === Number(i)) || C[0] || null, E = (0, _.useMemo)(() => {
		...
		try {
			let n = await fetch(`/wp-json/wingate-tools/v1/bar/menus/${e}/export?format=${encodeURIComponent(t)}`);
			if (!n.ok) return;
			let r = await n.json();
			if (t === "pdf") {
			...
			o.href = a, o.download = String(r?.fileName || "bar-menu.csv"), document.body.appendChild(o), o.click(), o.remove(), URL.revokeObjectURL(a);
		} catch {}
	}, k = (e) => {
				...
				children: [
					...
					/* @__PURE__ */ (0, v.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, v.jsxs)("div", {
							className: "bar-hero-copy max-w-3xl rounded-2xl border border-white/18 bg-white/[0.05] p-6 md:p-8 backdrop-blur-sm",
							children: [
								/* @__PURE__ */ (0, v.jsx)("p", {
									className: "text-xs uppercase tracking-[0.22em] text-brand-yellow font-bold",
									children: "Club House Bar"
								}),
								/* @__PURE__ */ (0, v.jsx)("h1", {
									className: "mt-3 font-cinzel text-white text-5xl md:text-6xl",
									children: S.heroTitle || "The Loyal / Ancient"
								}),
								/* @__PURE__ */ (0, v.jsx)("p", {
				...
				children: [/* @__PURE__ */ (0, v.jsx)("div", {
					...
					children: C.map((e) => {
						...
						return /* @__PURE__ */ (0, v.jsxs)("button", {
							type: "button",
							onClick: () => A(e.id),
							className: `bar-menu-card text-left overflow-hidden rounded-xl border ${t ? "border-brand-yellow shadow-lg" : "border-brand-blue/12 shadow-sm"} bg-white transition-all hover:-translate-y-1`,
							children: [/* @__PURE__ */ (0, v.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, v.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, v.jsxs)("div", { children: [/* @__PURE__ */ (0, v.jsx)("p", {
							...
							children: S.openTimesTitle || "Bar Hours"
						}), /* @__PURE__ */ (0, v.jsx)("ul", {
						...
						/* @__PURE__ */ (0, v.jsxs)("div", { children: [/* @__PURE__ */ (0, v.jsx)("p", {
							className: "text-[11px] uppercase tracking-[0.16em] text-brand-yellow font-bold",
							children: "Loyal & Ancient Experience"
						}), /* @__PURE__ */ (0, v.jsx)("p", {
							className: "mt-3 text-sm text-white/90",
							children: "Classic pours, curated cocktail service, and a premium social setting for members and guests."
						})] }),
						/* @__PURE__ */ (0, v.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, v.jsxs)("a", {
								...
								children: [
									...
									/* @__PURE__ */ (0, v.jsx)("span", { children: S.bookingLabel || "Reserve Bar Table" }),
									/* @__PURE__ */ (0, v.jsx)(f, { size: 14 })
								]
							}), S.whatsAppEnabled && S.whatsAppNumber ? /* @__PURE__ */ (0, v.jsxs)("a", {
								href: `https://wa.me/${String(S.whatsAppNumber).replace(/\D/g, "")}?text=${encodeURIComponent(S.whatsAppMessage || "Hello Loyal & Ancient team, I would like to reserve a table.")}`,
								...
								target: "_blank",
								rel: "noreferrer",
								children: [/* @__PURE__ */ (0, v.jsx)("span", { children: S.whatsAppLabel || "WhatsApp Bar" }), /* @__PURE__ */ (0, v.jsx)(f, { size: 14 })]
							}) : null]
						})
					]
				})
