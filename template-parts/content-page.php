<?php
/**
 * Shared body for the theme's branded page templates (page.php and
 * page-styled-default.php): hero banner (post title/subtitle/featured
 * image) followed by the prose-styled page content.
 *
 * Expects the loop to already be positioned via the_post() in the caller.
 *
 * @package Wingate
 */
...
<div class="bg-white min-h-screen relative overflow-hidden">
	...
	<header class="relative w-full min-h-[460px] md:min-h-[560px] lg:min-h-[640px] flex items-center justify-center bg-brand-blue overflow-hidden">
		...
		<?php endif; ?>
		<div class="absolute inset-x-0 bottom-0 h-1 bg-gradient-to-t from-white to-transparent dark:from-dark-canvas"></div>
