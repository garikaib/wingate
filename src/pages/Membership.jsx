    ...
    return (
        <div className="bg-brand-gray min-h-screen font-montserrat">
            ...
            <header ref={heroRef} className="relative h-[70vh] flex items-center justify-center bg-brand-blue overflow-hidden">
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/wp-content/uploads/2026/02/20260110_082734-scaled.jpg')" }}></div>
                <div className="absolute inset-0 bg-gradient-to-b from-brand-blue/60 via-brand-blue/40 to-brand-blue/90"></div>

                <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
                    <h1 ref={titleRef} className="text-5xl md:text-7xl font-cinzel text-brand-yellow mb-6 tracking-wide drop-shadow-lg">
                        Join the Legacy
                    </h1>
                    <p className="text-lg md:text-xl text-white/90 font-light tracking-wider mb-8">
                        Join our 18-hole, tree-lined course in Pomona, Harare, with membership options for full, country, senior, limited-round, ladies, and student/junior players.
                    </p>
                </div>
            </header>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <span className="text-brand-yellow font-cinzel tracking-widest uppercase text-sm font-bold">Options</span>
                        <h2 className="text-4xl font-cinzel text-brand-blue mt-2">Membership Tiers</h2>
                    ...
                    <div className="mt-20 max-w-4xl mx-auto bg-brand-blue text-white p-10 md:p-14 text-center rounded-sm relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-3xl font-cinzel text-brand-yellow mb-4">Ready to Apply?</h3>
                            <p className="mb-8 text-white/80 max-w-lg mx-auto">
                                Download the application form manually if you prefer the traditional route.
                            </p>
                            <a
